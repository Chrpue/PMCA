...
from core.assistant.factory import PMCAAgentFactory, PMCASpecialAgents
from core.assistant.special_agents import PMCACodeGenExec, PMCACodeGenExecTool, PMCAUser
from core.team.factory import PMCATeam, PMCATeamFeedBack
...
class PMCASwarm(PMCATeam):
    ...
    def termination(self) -> TerminationCondition:
        """设置群组的终止条件"""
        return (
            TextMentionTermination(PMCATeamFeedBack.FINISHED)
            | TextMentionTermination(PMCATeamFeedBack.NEEDUSER)
