...
from base.knowledge.decision import PMCAAgentsDecisionKnowledge


class PMCAAgentsDecisionLRMemory(Memory):
    ...
    async def query(
        ...
        **kwargs: Any,
        ...
        retrieve = PMCAAgentsDecisionKnowledge.query(query_str)
